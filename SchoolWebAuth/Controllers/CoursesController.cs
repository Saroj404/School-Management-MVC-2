...
namespace SchoolWebAuth.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,CourseName,Duration,Teacherid")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,CourseName,Duration,Teacherid")] Course course)
        {
            if (ModelState.IsValid)
            {
